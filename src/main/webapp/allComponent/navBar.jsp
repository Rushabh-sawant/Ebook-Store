...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active ml-1"><a class="nav-link" href="#"><i
					class="fas fa-home"></i> Home <span class="sr-only">(current)</span>
			</a></li>
			<li class="nav-item active ml-1"><a class="nav-link" href="#"><i
					class="fas fa-book-open"></i> Recent Books</a></li>
			<li class="nav-item active ml-1"><a class="nav-link" href="#"><i
					class="fas fa-book-open"></i> New Books</a></li>

			<li class="nav-item active ml-1"><a class="nav-link" href="#"><i
					class="fas fa-book-open"></i> Old Books</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
